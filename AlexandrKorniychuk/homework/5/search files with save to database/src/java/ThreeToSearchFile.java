...
import src.jdbc.OtherOptionsJDBC;
...
public class ThreeToSearchFile {

    private static List<Runnable> tasks = new ArrayList<>();
    private static int n = 0;

    private static OtherOptionsJDBC othOp = new OtherOptionsJDBC();
...
//                    System.out.println("level folder: " + tasks.size());
                    othOp.insertWritePath(file.getAbsolutePath());
